...
from oheflow.models.flow_matching import sample as cfm_sampler
from oheflow.models.modules import MLPDiffusion, Model
from oheflow.models.flow_matching import ConditionalFlowMatcher
...
def sample(
    ...
    x_gen = cfm_sampler(model, num_samples, d_in, N=steps, device=device, use_tqdm=True) # Sampling Steps
    syn_data = x_gen
